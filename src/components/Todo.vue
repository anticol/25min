<template>
    <div id="todo">
        <section class="todo-wrapper">
            <h1  v-if="false" class="todo-title">{{ today.date }}</h1>
            <form @keydown.enter.prevent="">
                ...
                <div class="btn btn-add" v-bind:class="{ active: new_todo }"  @click="addItem"><img class="plus" src="../assets/plus.png"> </div>
            </form>
...
<script>
    export default {
        ...
        data() {
            return {
                todoList: [
                    {"id":0,"title":"Start working...","done":false},
...
<style scoped>
    *{
    ...
    .todo-wrapper{
        ...
        border-radius: 4px;
        padding: 40px 20px;
        -webkit-box-shadow: 0 0 30px 0 rgba(232, 221, 221, 0.05);
        box-shadow: 0 0 30px 0 rgba(232, 221, 221, 0.05);
        overflow: hidden;
        position: relative;
        margin-bottom: 0px;
    }
